...
<ol type="a">
<li> "Vendor" means <a href="<?php echo $GLOBALS['SETTINGS']['vendorUrl']; ?>" target="_blank"><?php echo htmlencode($GLOBALS['SETTINGS']['vendorName']); ?></a></li>
...
<p>7. <b>UPGRADES. </b> If this copy of the software is an upgrade from an
...
<p>8. <b>TRANSFER. </b>  You may make a one-time transfer of the Software
and Your rights under this license to another party provided that:</p>

<ol type="a">
<li> You provide the party with the Software, and this license.</li>
...
<a name="sublicensing"></a>
<?php if (allowSublicensing()): ?>
<p>9. <b>SUBLICENSING.</b> You may sublicense the Software and Your rights under
...
<p>10. <b>TERMINATION.</b> Vendor may terminate Your license if You do not abide
by the license terms. Upon termination of license, You shall immediately discontinue the use of the
...
<p>11. <b>DISCLAIMER OF WARRANTY.</b> The Software is provided on an "AS IS"
...
<p>12. <b>LIMITATION OF LIABILITY. UNDER NO CIRCUMSTANCES AND UNDER NO LEGAL
...
<p>13. <b>APPLICABLE LAW.</b> This license shall be interpreted in accordance
with the laws of <?php echo $GLOBALS['SETTINGS']['vendorLocation']; ?>. Any disputes arising out of this license
shall be adjudicated in a court of competent jurisdiction in <?php echo $GLOBALS['SETTINGS']['vendorLocation']; ?>.</p>

<p>14. <b>GOVERNING LANGUAGE.</b> Any translation of this License is done for
...
<p>15. <b>ENTIRE AGREEMENT.</b> This license constitutes the entire agreement
...
<hr size="1">
<p>Software License Agreement v3.5 (February 24th, 2022)</p>
</div><br><br>

<div>
  Should you have any questions concerning this license,
  or if you desire to contact us for any reason, please email or call:
  <a href="<?php echo $GLOBALS['SETTINGS']['vendorUrl']; ?>" target="_blank"><?php echo htmlencode($GLOBALS['SETTINGS']['vendorName']); ?></a>
</div>
...
<form method="get" action="?" autocomplete="off">
  <div style="float:right;">
    <input style="padding: 10px 20px; margin-bottom: 10px;" type="submit" name="null" value="<?php echo ("Done") ?>">
  </div>
</form>
